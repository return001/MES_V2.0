...
yxyDES::~yxyDES()
{}
void yxyDES::InitializeKey(string s,bool IsSecondKey)
{
...
string yxyDES::BinaryToString(char* szSource,int len,bool bType)
{
        ...
        if(bType)
        {
                ...
                for(int i=0;i<ilen;i++)
                {
                        ...
                        char buffer_yxyDES[3] = {0};
                        itoa(iCh,buffer_yxyDES,16);
                        //if the integer less than 16,insert a zero to buffer
                        if(iCh < 16)
                        {
                                char cTmp = buffer_yxyDES[0];
                                buffer_yxyDES[0] = '0';
                                buffer_yxyDES[1] = cTmp;
								buffer_yxyDES[2] = '\0';
                        }
                        s_return += buffer_yxyDES[0];
                        s_return += buffer_yxyDES[1];
                }
...
void yxyDES::CreateSubKey(char* sz,char szKeyArray[16][48])
{
        char szTmpL[28] = {0};
        char szTmpR[28] = {0};
        char szCi[28] = {0};
...
void yxyDES::EncryptData(string s,bool bIsUseSecondKey,bool bShowResultInHex)
{
        char sz_IP[64] = {0};
        char sz_Li[32] = {0};
        char sz_Ri[32] = {0};
        ...
        memcpy(szCiphertext,BinaryToString(szCiphertextBinary,64,bShowResultInHex).c_str(),16);
}

void yxyDES::DecryptData(string s,bool bIsUseSecondKey,bool bDecryptHex)
{
        char sz_IP[64] = {0};
        char sz_Li[32] = {0};
        char sz_Ri[32] = {0};
...
void yxyDES::FunctionF(char* sz_Li,char* sz_Ri,bool bIsUseSecondKey,int iKeyNum)
{
        char sz_48R[48] = {0};
        char sz_xor48[48] = {0};
        char sz_P32[32] = {0};
