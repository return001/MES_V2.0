 ...
 */
	...
	const ANCHOR TOP_LEFT2(10, 0);
	const ANCHOR TOP_LEFT3(20, 0);
	const ANCHOR TOP_LEFT4(30, 0);
	const ANCHOR TOP_LEFT5(40, 0);
	const ANCHOR TOP_LEFT6(60, 0);
	const ANCHOR TOP_LEFT7(70, 0);
	const ANCHOR TOP_LEFT8(80, 0);
	const ANCHOR TOP_LEFT9(90, 0);
	const ANCHOR TOP_LEFT10(100, 0);
	//! Anchor to the top edge and center horizontally
	const ANCHOR TOP_CENTER(50, 0);//x,y
	...
	const ANCHOR MIDDLE_LEFT2(10, 50);
	const ANCHOR MIDDLE_LEFT3(20, 50);
	const ANCHOR MIDDLE_LEFT4(30, 50);
	const ANCHOR MIDDLE_LEFT5(40, 50);
	const ANCHOR MIDDLE_LEFT6(60, 50);
	const ANCHOR MIDDLE_LEFT7(70, 50);
	const ANCHOR MIDDLE_LEFT8(80, 50);
	const ANCHOR MIDDLE_LEFT9(90, 50);
	const ANCHOR MIDDLE_LEFT10(100, 50);
	...
	const ANCHOR BOTTOM_LEFT2(10, 100);
	const ANCHOR BOTTOM_LEFT3(20, 100);
	const ANCHOR BOTTOM_LEFT4(30, 100);
	const ANCHOR BOTTOM_LEFT5(40, 100);
	const ANCHOR BOTTOM_LEFT6(60, 100);
	const ANCHOR BOTTOM_LEFT7(70, 100);
	const ANCHOR BOTTOM_LEFT8(80, 100);
	const ANCHOR BOTTOM_LEFT9(90, 100);
	const ANCHOR BOTTOM_LEFT10(100, 100);
