...
namespace DataRelative.Param.BLL
{
    class DataRelativeSheetBLL
    {
        ...
        public string SelectIccidBySimAndImeiBLL(string SIM,string IMEI)
        {
            return DRSD.SelectIccidBySimAndImeiDAL(SIM,IMEI);
        }
        ...
        public string SelectIMEIBySnOrIMEI2BLL(string IMEI2OrSn,string IMEI2Value)
        {
            return DRSD.SelectIMEIBySnOrIMEI2DAL(IMEI2OrSn, IMEI2Value);
        }
    }
}
