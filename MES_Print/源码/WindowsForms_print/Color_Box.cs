    ...
    public partial class Color_Box : Form
    {
        ...
        private void CB_ZhiDan_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (Gps_ManuOrderParam b in G_MOP)
            {
                ...
                if(b.Remark5 == "FT")
                {
                    this.UpdateIMEIBySim.Checked = true;
                    this.UpdataSimByImei.Checked = false;
                }else if(b.Remark5 == "TF")
                {
                    this.UpdateIMEIBySim.Checked = false;
                    this.UpdataSimByImei.Checked = true;
                }
                if (b.Remark4 != "")
                {
                    string rem4 = b.Remark4;
                    string[] remark4 = rem4.Split('@');
                    this.Tempalte1Num.Text = remark4[0];
                    this.Tempalte2Num.Text = remark4[1];
                }
                else
                {
        ...
        private void choose_sim_Click(object sender, EventArgs e)
        {
            ...
            if (this.choose_sim.Checked == true)
            {
                ...
                g1 = 1;
                g = g + g1;
                //this.reminder.AppendText(g.ToString());
            }
            else {
                //this.SIMStart.ReadOnly = true;
                this.IMEI_Start.Clear();
        ...
        private void ToLock_Click(object sender, EventArgs e)
        {
            ...
            //存放SIM卡号的更新关系并记录到制单中
            string UpdataSimflag;
            string PrintNumFlag;
            if(this.UpdataSimByImei.Checked == true)
            {
                UpdataSimflag = "TF";
            }else if(this.UpdateIMEIBySim.Checked == true)
            {
                UpdataSimflag = "FT";
            }
            else
            ...
            PrintNumFlag = this.Tempalte1Num.Text +"@"+ this.Tempalte2Num.Text;
            MOPB.UpdateRemark5BLL(this.CB_ZhiDan.Text, PrintNumFlag, UpdataSimflag);
        }
