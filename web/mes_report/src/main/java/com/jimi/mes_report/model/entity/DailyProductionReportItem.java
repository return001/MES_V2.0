...
public class DailyProductionReportItem {
	...
	private int dailyProductionQuantity;
	 ...
	 * 获取订单当天实际完成数量
	 */
	public int getDailyProductionQuantity() {
		return dailyProductionQuantity;
	}
	 ...
	 * 设置订单当天实际完成数量
	 */
	public void setDailyProductionQuantity(int dailyProductionQuantity) {
		this.dailyProductionQuantity = dailyProductionQuantity;
	}
