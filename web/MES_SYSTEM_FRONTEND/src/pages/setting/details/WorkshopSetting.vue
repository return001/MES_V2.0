<template>
  ...
  <div id="workshop-setting">
    <div class="workshop-setting-main">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        /*搜索框*/
        queryConfig: WorkshopQueryConfig,
        buttonGroup: [
          {
            label: '重置条件',
            size: 'small',
        ...
        queryCompData: {},
        tableColumns: WorkshopTableColumns,
        tableData: [],
        ...
        formConfig: {
          refName: 'workshopFormComp',
          size: 'small',
          identity: 'workshop-item-'
        },
        formItemList: WorkshopFormItems,
        formRules: WorkshopFormRules,
        formData: {},

        /*链接重定义*/
        formAddUrl: eSopWorkshopAddUrl,
        formDeleteUrl: eSopWorkshopDeleteUrl,
        formUpdateUrl: eSopWorkshopEditUrl,
