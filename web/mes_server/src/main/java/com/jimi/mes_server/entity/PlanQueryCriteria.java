...
public class PlanQueryCriteria {
	...
	public String toString() {
		return "PlanQueryCriteria [pageNo=" + pageNo + ", pageSize=" + pageSize + ", schedulingPlanStatus="
				+ schedulingPlanStatus + ", zhidan=" + zhidan + ", customerName=" + customerName + ", orderDateFrom="
				+ orderDateFrom + ", orderDateTo=" + orderDateTo + ", planStartTimeFrom=" + planStartTimeFrom
				+ ", planStartTimeTo=" + planStartTimeTo + ", planCompleteTimeFrom=" + planCompleteTimeFrom
				+ ", planCompleteTimeTo=" + planCompleteTimeTo + ", startTimeFrom=" + startTimeFrom + ", startTimeTo="
				+ startTimeTo + ", completeTimeFrom=" + completeTimeFrom + ", completeTimeTo=" + completeTimeTo
				+ ", processGroup=" + processGroup + ", line=" + line + ", productionPlanningNumber="
				+ productionPlanningNumber + ", softModel=" + softModel + ", productNo=" + productNo + "]";
	}
}
